...
static struct argp_option options[] = {
	...
	{"num-stars",	's', "INT", 0, "Number of stars to use - The number of stars to use to form triangles with to try to make a valid match, more is not always better (Default=15,Max=50)" },
